...
## Example
See an online example/playground [here](https://raw.githack.com/GastonZalba/tiny-popup-menu/v1.0.9/examples/basic.html).
...
```HTML
<script src="https://unpkg.com/tiny-popup-menu@1.0.9"></script>
```

#### CSS

```HTML
<link rel="stylesheet" href="https://unpkg.com/tiny-popup-menu@1.0.9/dist/css/tiny-popup-menu.min.css" />
```
